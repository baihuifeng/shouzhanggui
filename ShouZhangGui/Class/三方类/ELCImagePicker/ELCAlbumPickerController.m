    ...
    dispatch_async(dispatch_get_main_queue(), ^
    {
        ...
        // Group enumerator Block
            ...
            void (^assetGroupEnumberatorFailure)(NSError *) = ^(NSError *error) {
                ...
                {
                    NSString *errorMessage = NSLocalizedStringFromTable(@"请在设置中修改允许家园金管家访问照片", @"CommonUtil", nil);
                    [[[UIAlertView alloc] initWithTitle:NSLocalizedStringFromTable(@"此应用程序没有权限来访问您的照片或视频", @"CommonUtil", nil)
                                                message:errorMessage
                                               delegate:nil
                                      cancelButtonTitle:NSLocalizedStringFromTable(@"Ok", @"",nil)
                                      otherButtonTitles:nil] show];
                  
                }
                else
                {
                    NSString *errorMessage = NSLocalizedStringFromTable(@"FAILED_TO_PHOTO_Msg", @"CommonUtil", nil);
                    [[[UIAlertView alloc] initWithTitle:nil
                                                message:errorMessage
                                               delegate:nil
                                      cancelButtonTitle:NSLocalizedStringFromTable(@"Ok", @"",nil) otherButtonTitles:nil] show];
                }
...
{
	[self.tableView reloadData];
	[self.navigationItem setTitle:NSLocalizedStringFromTable(@"Image_Picker_Title",  @"CommonUtil", nil)];
}
